...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> KAISAR SARWAR</p>
    
        <div class="social-icons">
            
        <a href="https://www.facebook.com/robin.milford.12327" class='active'><i class="icon fa fa-facebook"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">kaisarvam@gmail.com</a></span>
                </div>
            </li>
