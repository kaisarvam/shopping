...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> COD
	     ...
	     <input type="submit" value="submit For internet banking and cod" name="submit" class="btn btn-primary">
		 <input type=button onClick="location.href='paymentend.html'" value='click here for debit or credit card payment'>
